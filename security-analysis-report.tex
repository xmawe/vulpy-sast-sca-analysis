...
\begin{itemize}[leftmargin=*]
    \item \textbf{Lien du projet :} \url{https://github.com/xmawe/vulpy-sast-dast-analysis}
    
    \item \textbf{Rapports SAST avant corrections :} \url{https://github.com/xmawe/vulpy-sast-dast-analysis/tree/main/reports/sast/before-vul-correction}
    
    \item \textbf{Rapports SAST après corrections :} \url{https://github.com/xmawe/vulpy-sast-dast-analysis/tree/main/reports/sast/after-vul-correction}
    
    \item \textbf{Rapports DAST avant corrections :} \url{https://github.com/xmawe/vulpy-sast-dast-analysis/tree/main/reports/dast/before-val-correction}
    
    \item \textbf{Rapports DAST après corrections :} \url{https://github.com/xmawe/vulpy-sast-dast-analysis/tree/main/reports/dast/after-val-correction}
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{pipeline-overview-with-dast.png}
    \caption{Exécution du Pipeline (avec DAST)}
    \label{fig:placeholder}
\end{figure}
...
\textbf{Note :} Le Jenkinsfile complet g\`ere 14 stages avec des rapports s\'epar\'es pour bad/ et good/. Voir le fichier complet sur GitHub : \url{https://github.com/xmawe/vulpy-sast-dast-analysis/blob/main/Jenkinsfile}
...
\begin{itemize}[leftmargin=*]
    ...
    \url{https://github.com/xmawe/vulpy-sast-dast-analysis/tree/main/reports/sast/before-vul-correction}
    
    Ces rapports montrent l'état initial avec 11 vulnérabilités dans good/
    
    \item \textbf{Rapports SAST après corrections :}
    
    \url{https://github.com/xmawe/vulpy-sast-dast-analysis/tree/main/reports/sast/after-vul-correction}
    ...
    \url{https://github.com/xmawe/vulpy-sast-dast-analysis/tree/main/reports/dast/before-val-correction}
    
    Ces rapports montrent 13 avertissements DAST dans la version good/
    
    \item \textbf{Rapports DAST après corrections :}
    
    \url{https://github.com/xmawe/vulpy-sast-dast-analysis/tree/main/reports/dast/after-val-correction}
    ...
    \url{https://github.com/xmawe/vulpy-sast-dast-analysis}
\end{itemize}
